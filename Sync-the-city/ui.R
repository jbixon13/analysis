...
shinyUI(
  bs4DashPage(
    ...
    sidebar = bs4DashSidebar(
      ...
      title = 'Sync the City',
      brandColor = 'primary',
      src = 'sync_map/www/sync_logo_v2.png',
      bs4SidebarMenu(bs4SidebarHeader('Header'),
                     bs4SidebarMenuItem('Home', tabName = 'Home', icon = 'home'),
                     bs4SidebarMenuItem('Map', tabName = 'Map', icon = 'map-marker-alt'),
                     bs4SidebarMenuItem('Network', tabName = 'Network', icon = 'project-diagram')
                     )
      ),
    body = bs4DashBody(
      bs4TabItems(
          ...
          fluidRow(
            column(width = 12,
                   bs4Jumbotron(
                     ...
                     lead = 'Synchronizing change throughout the city.'
                     )
                   )
          ),
          fluidRow(
            column(width = 4,
                   bs4Box(title = 'Who',
                          'A Code for Baltimore Project',
                          width = NULL
                          )
                   ),
            column(width = 4,
                   bs4Box(title = 'What',
                          'A tool to organize efforts and identify opportunities for organizations in Baltimore',
                          width = NULL
                          )
                   ),
            column(width = 4,
        ...
        bs4TabItem(
          ...
          fluidRow(
            column(width = 3,
                   bs4Box(title = 'Group Select',labelTooltip = 'tip',labelText = 'Hover for Help',
                          selectizeInput('groupSelect',
                                         'Group Select Label',
                                         choices = groups_codes,
                                         multiple = TRUE,
                                         options = list(plugins = list('remove-button'))
                                         ),
                          width = NULL
                          ),
                   bs4Box(title = 'Zip Select',
                          selectizeInput('zipSelect',
                                         'Zip Select Label',
                                         choices = unique(geo_data$ZIP_FIVE),
                                         multiple = TRUE,
                                         options = list(plugins = list('remove-button'))
    ...
    footer = bs4DashFooter(
      copyrights = a(
        href = 'https://github.com/syncthecity/shinymap',
        target = "_blank",
        'Github'
        ),
      right_text = '2019'
